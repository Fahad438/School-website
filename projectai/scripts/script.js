...
function valid() {
	...
	//validate Address
	var adr = document.getElementById("Pahone").value;
	if (!adr) {
		valid = false;
		document.getElementById("errPahone").innerHTML = "Please enter in your Pahone";


	}
	else {
		document.getElementById("errPahone").innerHTML = "";
	...
	if (document.getElementById("topic").value == "Select a topic") {
		valid = false;
		document.getElementById("errtopic").innerHTML = " Choose a Topic ";
